...
const MagicWord = () => {
    ...
    return <div className = "flex flex-row flex-wrap">
        ...
        <div className = {`flex flex-row transition duration-300 border border-zinc-400 
            
            ${!isPressed ? "hover:border-green-500" : "border-green-500"}
...
const ToCListing = ({children, id}) => {
    ...
    return <li onClick = {() => {handleScroll(id)}} className = "select-none cursor-pointer">{children}</li>
}
